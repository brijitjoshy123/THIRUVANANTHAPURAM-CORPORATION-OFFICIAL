...
map.getView().fit([76.788006, 8.498524, 76.974411, 8.608417], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">THIRUVANATHAPURAM CORPORATION</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (180 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'THIS IS AN ELABORATED MAP OF THIRUVANANTHAPURAM CORPORATION,WHICH PROVIDES DETAILED INFORMATION ABOUT GEOMORPHOLOGY, DRAINAGE, ROAD NETWORK, JUNCTIONS, TOURIST SPOTS, RAILWAY ETC. ';
            }
